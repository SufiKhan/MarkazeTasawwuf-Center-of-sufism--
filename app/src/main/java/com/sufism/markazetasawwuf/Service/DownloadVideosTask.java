...
public class DownloadVideosTask extends AsyncTask<ArrayList<String>, Integer, String> {

    private Activity mContext;
    private RecyclerView.Adapter mAdapter;

    public DownloadVideosTask(Activity context, RecyclerView.Adapter adapter) {
        mContext = context;
        mAdapter = adapter;
    ...
    protected void onProgressUpdate(Integer... values) {
       ...
       // final Integer[] progress = values;
        MyApplication.getContext().setProgress(values[0]);
//        mContext.runOnUiThread(new Runnable() {
//            @Override
//            public void run() {
//                MyApplication.getContext().showDeterminate(mContext,progress[0]);
//            }
//        });
